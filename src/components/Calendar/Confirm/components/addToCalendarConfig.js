...
export const makeGoogleCalendarUrl = (event) =>
...
export const makeOutlookCalendarUrl = (event) =>
...
export const makeYahooCalendarUrl = (event) =>
...
export const makeICSCalendarUrl = (event) => {
